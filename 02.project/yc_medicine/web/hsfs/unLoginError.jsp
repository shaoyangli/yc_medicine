...
<html>
  <head>
	...
	function goLogin() {
		window.parent.parent.parent.location='<%=path %>/hsfs/userLogin.jsp';
	}
	</script>
  ...
  <body>
    <div align="center" style="font-size: 15px;">请登陆......<a href="javascript:void(0)" onclick="goLogin()">点击重新登录</a></div>
