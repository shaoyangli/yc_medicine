...
var superTable = function (tableId, options) {
	...
	if(this.sDataTable.tBodies[0].rows[(this.sDataTable.tHead) ? 0 : this.headerRows]==undefined){
	...
	if (this.fixedCols > 0) {
		...
		this.sFHeader.style.width = this.sFHeaderWidth + "%";
		sDataTableStyles += "margin-left: " + (this.sFHeaderWidth * -1) + "%;";
		sDataStyles += "margin-left: " + this.sFHeaderWidth + "%;";
		sDataStyles += "width: " + (this.sParentWidth - this.sFHeaderWidth) + "%;";
	} else {
		sDataStyles += "width:100%";
	}
